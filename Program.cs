//string[] heroes = { "Harry", "Pumkin", "Põrguvyrst",  "Lumivalge", "Musihuul" };
//string[] villains = { "Voldemar", "Eduard", "Põmmpea", "Kandik", "Jokker" };
...
int heroStrikeStrengt = heroHP;
Console.WriteLine($"Today  {hero} ({heroHP} HP)with {heroWeapon} saves the day!");

string villain = GetRandomValueFromArray(villains);
string villainWeapon = GetRandomValueFromArray(weapon);
int villainHP = GetCharacterHP(villain);
int villainStrikeStrengt = villainHP;
Console.WriteLine($"Today  {villain} ({villainHP} HP) with {villainWeapon} tries to take the world!");
